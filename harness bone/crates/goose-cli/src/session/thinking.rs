...
/// Thinking messages shown while NGOPilot is working.
const THINKING_MESSAGES: &[&str] = &[
    "Reviewing the mission",
    "Mapping stakeholder needs",
    "Organizing the workplan",
    "Connecting program details",
    "Checking operational context",
    "Gathering supporting evidence",
    "Reviewing available data",
    "Clarifying priorities",
    "Structuring the response",
    "Calculating next steps",
    "Checking program constraints",
    ...
    "Aligning tasks and outcomes",
    "Navigating project materials",
    "Developing practical options",
    "Ordering the next actions",
    "Reviewing connected workstreams",
