...
/mode <name> - Set the NGOPilot mode to use ({modes})
...
/plan <message_text> -  Enters 'plan' mode with optional message. Create a plan based on the current messages and asks user if they want to act on it.
                        If user acts on the plan, NGOPilot mode is set to 'auto' and returns to 'normal' NGOPilot mode.
                        To warm up NGOPilot before using '/plan', we recommend setting '/mode approve' & putting appropriate context into NGOPilot.
...
/endplan - Exit plan mode and return to 'normal' NGOPilot mode.
...
fn print_editor_help() {
  ...
  Configure editor: ngopilot configure set goose_prompt_editor \"vim\"
  ...
  To use inline prompts with on-demand /edit: ngopilot configure set goose_prompt_editor_always false"
    );
}
