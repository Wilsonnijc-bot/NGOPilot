...
fn build_template(messages: &[&str], prefill: Option<&str>) -> String {
    let mut content = String::from("# NGOPilot Prompt Editor\n\n");
...
mod tests {
    ...
    fn test_extract_user_input_with_editor_output() {
        let content = r#"# NGOPilot Prompt Editor
...
"#;
    ...
    fn test_create_temp_file_with_messages() {
        ...
        assert!(content.contains("# NGOPilot Prompt Editor"));
...
"#;
    ...
    fn test_build_template_no_prefill_no_messages() {
        ...
        assert_eq!(content, "# NGOPilot Prompt Editor\n\n# Your prompt:\n\n");
    }
