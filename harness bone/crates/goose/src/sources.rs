...
mod tests {
    ...
    fn list_sources_lists_builtin_skills() {
        ...
        let builtin = listed
            .iter()
            .find(|source| source.name == "ngopilot-doc-guide")
            .expect("expected ngopilot-doc-guide builtin skill");

        assert_eq!(builtin.source_type, SourceType::BuiltinSkill);
        assert!(builtin.global);
        assert_eq!(builtin.path, "builtin://skills/ngopilot-doc-guide");
    ...
    fn filesystem_skill_suppresses_same_named_builtin() {
        ...
        assert!(!builtins
            .iter()
            .any(|source| source.name == "ngopilot-doc-guide"));
