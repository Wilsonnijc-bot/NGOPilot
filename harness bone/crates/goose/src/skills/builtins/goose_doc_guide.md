---
name: ngopilot-doc-guide
description: Reference NGOPilot documentation to create, configure, or explain NGOPilot-specific features like recipes, extensions, sessions, and providers. You MUST read the relevant NGOPilot docs before answering. You MUST NOT rely on training data or assumptions for any NGOPilot-specific fields, values, names, syntax, or commands.
---

Use this skill when working with **NGOPilot-specific features**:
- Creating or editing recipes
- Configuring extensions or providers
- Explaining how NGOPilot features work
- Any NGOPilot configuration or setup task

Do NOT use this skill for:
- General coding tasks unrelated to NGOPilot
...
2. **Create/modify content**
   - For NGOPilot configuration files:
      ...
      - **STOP: Before showing the user, verify output content MUST match the schema and reference in the NGOPilot official documentation:**
...
3. **MANDATORY VERIFICATION - CHECK ALL THESE ITEMS BEFORE STEP 4**
   ...
   - [ ] You MUST NOT rely on training data or assumptions for any NGOPilot-specific fields, values, names, syntax, or commands.
   ...
   - [ ] List all NGOPilot-specific items in your answer (commands, fields, syntax, values, how to use, explanations, etc.)
...
4. **Provide your answer and include a "Verification Completed" section**
   - For EACH NGOPilot-specific item in your response, cite the specific doc file where you verified it
