...
const i18n = defineMessages({
  ...
  appearanceDesc: {
    ...
    defaultMessage: 'Configure how NGOPilot appears on your system',
  },
  ...
  themeDesc: {
    ...
    defaultMessage: 'Customize the look and feel of NGOPilot',
  },
  languageTitle: { id: 'settings.language.title', defaultMessage: 'Language' },
  languageDesc: {
    id: 'settings.language.description',
    defaultMessage: 'Choose the display language for NGOPilot',
  },
  // Keep legacy catalog keys declared while NGOPilot exposes its two supported languages.
  ...
  helpDesc: {
    ...
    defaultMessage: 'Help us improve NGOPilot by reporting issues or requesting new features',
  },
  ...
  updatesDesc: {
    ...
    defaultMessage: 'Check for and install updates to keep NGOPilot running at its best',
  },
  ...
  notificationsMacStep3: {
    ...
    defaultMessage: 'Find and select NGOPilot in the application list',
  },
  ...
  return (
    <div className="space-y-4 pr-4 pb-8 mt-1">
      ...
      <Card className="rounded-lg">
        ...
        <CardContent className="pt-4 px-4">
          <LanguageSelector className="w-full max-w-[260px]" menuAlign="start" />
        </CardContent>
      </Card>
      <TelemetrySettings />
