...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default NGOPilot starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. NGOPilot checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  secretKeyHelp: {
    ...
    defaultMessage:
      'The secret key configured on the external backend (NGOPILOT_SERVER__SECRET_KEY).',
  },
  certFingerprint: {
  ...
  restartNote: {
    ...
    defaultMessage: 'Changes apply to new chat windows. Restart NGOPilot to update existing windows.',
  },
  urlProtocolError: {
