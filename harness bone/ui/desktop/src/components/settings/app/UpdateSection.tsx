...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, NGOPilot will notify you of new versions but will not download them automatically.',
  },
  autoDownloadDisabledByEnv: {
    id: 'updateSection.autoDownloadDisabledByEnv',
    defaultMessage:
      'Automatic downloads are disabled via the NGOPILOT_DISABLE_AUTO_DOWNLOAD environment variable.',
  },
  downloadNow: {
  ...
  autoDownload: {
    ...
    defaultMessage:
      'NGOPilot will download the update in the background and install it the next time you quit or restart.',
  },
  manualInstallNote: {
  ...
  readyInstallAuto: {
    ...
    defaultMessage:
      "✓ Update is ready. Restart NGOPilot to finish installing it, or quit when you're done.",
  },
  installNowHint: {
