...
const i18n = defineMessages({
  ...
  addApiKeyDescription: {
    ...
    defaultMessage: 'Add your API key(s) for this provider to integrate into NGOPilot',
  },
  oauthLoginFailed: {
  ...
  externalSetupIntro: {
    ...
    defaultMessage: 'This provider is configured outside of NGOPilot. Follow these steps:',
  },
  seeDocumentation: {
