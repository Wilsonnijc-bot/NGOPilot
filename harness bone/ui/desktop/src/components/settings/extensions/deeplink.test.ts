...
describe('addExtensionFromDeepLink', () => {
  ...
  describe('header parsing', () => {
    it('should preserve = characters in header values', async () => {
      const url =
        'ngopilot://extension?name=Remote&url=https%3A%2F%2Fexample.com%2Fmcp&header=Authorization%3DBasic%20abc%3D%3D';
    ...
    it('should handle header values without = characters', async () => {
      const url =
        'ngopilot://extension?name=Remote&url=https%3A%2F%2Fexample.com%2Fmcp&header=X-Token%3Dabc123';
    ...
    it('should handle multiple headers', async () => {
      const url =
        'ngopilot://extension?name=Remote&url=https%3A%2F%2Fexample.com%2Fmcp&header=Authorization%3DBearer%20tok%3D%3D&header=X-Key%3Dval';
    ...
    it('should handle header with empty value', async () => {
      const url =
        'ngopilot://extension?name=Remote&url=https%3A%2F%2Fexample.com%2Fmcp&header=X-Empty%3D';
  ...
  describe('stdio command validation', () => {
    it('should allow ngopilot for bundled MCP deeplinks', async () => {
      const url =
        'ngopilot://extension?cmd=ngopilot&arg=mcp&arg=memory&name=Memory&description=Memory';
    ...
    it('should reject daemon commands in deeplinks', async () => {
      vi.mocked(toastService.handleError).mockImplementationOnce(() => {
        throw new Error('Invalid command');
      });

      const url =
        'ngopilot://extension?cmd=goosed&arg=mcp&arg=memory&name=Memory&description=Memory';
