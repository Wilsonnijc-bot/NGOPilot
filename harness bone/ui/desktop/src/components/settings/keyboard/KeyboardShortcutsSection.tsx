...
const i18n = defineMessages({
  ...
  focusWindowLabel: {
    ...
    defaultMessage: 'Focus NGOPilot Window',
  },
  focusWindowDescription: {
    id: 'keyboardShortcuts.focusWindowDescription',
    defaultMessage: 'Bring NGOPilot window to front from anywhere',
  },
  quickLauncherLabel: {
  ...
  newChatWindowDescription: {
    ...
    defaultMessage: 'Open a new NGOPilot window',
  },
  openDirectoryLabel: {
  ...
  categoryGlobalDescription: {
    ...
    defaultMessage: 'These shortcuts work system-wide, even when NGOPilot is not focused',
  },
  categoryApplication: {
  ...
  categoryApplicationDescription: {
    ...
    defaultMessage: 'These shortcuts work when NGOPilot is the active application',
  },
  categorySearch: {
  ...
  restartDescription: {
    ...
    defaultMessage:
      'Changes to application shortcuts (like New Chat, Settings, etc.) require restarting NGOPilot to take effect. Global shortcuts (Focus Window, Quick Launcher) work immediately.',
  },
  dismiss: {
