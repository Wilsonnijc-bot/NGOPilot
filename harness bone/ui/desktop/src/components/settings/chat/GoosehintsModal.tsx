...
const i18n = defineMessages({
  dialogTitle: {
    ...
    defaultMessage: 'Configure Project Hints (.ngopilothints)',
  },
  dialogDescription: {
    id: 'goosehintsModal.dialogDescription',
    defaultMessage:
      'Provide additional context about your project to improve communication with NGOPilot',
  },
  helpText1: {
    id: 'goosehintsModal.helpText1',
    defaultMessage:
      '.ngopilothints is a text file used to provide additional context about your project and improve the communication with NGOPilot.',
  },
  helpText2: {
    id: 'goosehintsModal.helpText2',
    defaultMessage:
      "Please make sure {bold} extension is enabled in the extensions page. This extension is required to use .ngopilothints. You'll need to restart your session for .ngopilothints updates to take effect.",
  },
  helpText3: {
  ...
  helpTextLink: {
    ...
    defaultMessage: 'using .ngopilothints',
  },
  errorReading: {
    id: 'goosehintsModal.errorReading',
    defaultMessage: 'Error reading .ngopilothints file: {error}',
  },
  fileFound: {
    id: 'goosehintsModal.fileFound',
    defaultMessage: '.ngopilothints file found at: {filePath}',
  },
  fileCreating: {
    id: 'goosehintsModal.fileCreating',
    defaultMessage: 'Creating new .ngopilothints file at: {filePath}',
  },
  placeholder: {
  ...
  failedToAccess: {
    ...
    defaultMessage: 'Failed to access .ngopilothints file',
  },
  failedToSave: {
    id: 'goosehintsModal.failedToSave',
    defaultMessage: 'Failed to save .ngopilothints file',
  },
  developer: {
...
export const GoosehintsModal = ({ directory, setIsGoosehintsModalOpen }: GoosehintsModalProps) => {
  const intl = useIntl();
  const goosehintsFilePath = `${directory}/.ngopilothints`;
  ...
  useEffect(() => {
    const fetchGoosehintsFile = async () => {
      try {
        ...
        console.error('Error fetching .ngopilothints file:', error);
  ...
  const writeFile = async () => {
    ...
    try {
      ...
      console.error('Error writing .ngopilothints file:', error);
