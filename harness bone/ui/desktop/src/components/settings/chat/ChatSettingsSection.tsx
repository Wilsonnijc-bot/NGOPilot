...
const i18n = defineMessages({
  ...
  modeDescription: {
    ...
    defaultMessage:
      'Choose the default mode NGOPilot uses for new sessions. Existing sessions keep their current mode.',
  },
  responseStylesTitle: {
  ...
  responseStylesDescription: {
    ...
    defaultMessage: 'Choose how NGOPilot should format and style its responses',
  },
});
