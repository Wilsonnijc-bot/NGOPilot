...
const i18n = defineMessages({
  heading: {
    ...
    defaultMessage: 'Help improve NGOPilot',
  },
  description: {
    id: 'telemetryConsentPrompt.description',
    defaultMessage:
      'Would you like to share anonymous usage data to help improve NGOPilot? We never collect your conversations, code, or personal data.',
  },
  learnMore: {
