...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'Applications from your MCP servers and Apps built by NGOPilot itself. You can ask it to create new apps through the chat interface and they will appear here.',
  },
  loading: {
    id: 'appsView.loading',
  ...
  noAppsDescription: {
    ...
    defaultMessage:
      'Open a chat and ask NGOPilot for the app you want to have. It can build one for you and that will appear here. Or if somebody shared an app, you can import it using the button above.',
  },
  customApp: {
