...
const i18n = defineMessages({
  ...
  importNostrDesc: { id: 'sessions.importNostr.description', defaultMessage: 'Paste a NGOPilot Nostr share link to fetch, decrypt, and import the session.' },
  importNostrPlaceholder: { id: 'sessions.importNostr.placeholder', defaultMessage: 'ngopilot://sessions/nostr?nevent=...&key=...' },
  importing: { id: 'sessions.importing', defaultMessage: 'Importing...' },
  chatHistoryDesc: { id: 'sessions.chatHistoryDesc', defaultMessage: 'View and search your past conversations with NGOPilot. {shortcut} to search.' },
