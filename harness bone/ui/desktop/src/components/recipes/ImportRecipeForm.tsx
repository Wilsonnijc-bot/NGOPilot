...
const i18n = defineMessages({
  ...
  deeplinkPlaceholder: {
    ...
    defaultMessage: 'Paste your ngopilot://recipe?config=... deeplink here',
  },
  deeplinkHint: {
    id: 'importRecipeForm.deeplinkHint',
    defaultMessage: 'Paste a recipe deeplink starting with "ngopilot://recipe?config="',
  },
  or: {
  ...
  reviewWarning: {
    ...
    defaultMessage: 'Ensure you review contents of recipe files before adding them to your NGOPilot interface.',
  },
  cancel: {
...
const importRecipeSchema = z
  .object({
    deeplink: z
      .string()
      .refine(
        (value) => !value || value.trim().startsWith('ngopilot://recipe?config='),
        'Invalid deeplink format. Expected: ngopilot://recipe?config=...'
      ),
    recipeUploadFile: z
      .instanceof(File)
      .nullable()
