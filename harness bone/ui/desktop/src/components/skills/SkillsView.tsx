...
const i18n = defineMessages({
  ...
  noSkillsDescription: {
    ...
    defaultMessage:
      'Skills are loaded from SKILL.md files in ~/.config/agents/skills/, .agents/skills/, or other supported directories.',
  },
  noMatchingSkills: {
  ...
  skillsDescription: {
    ...
    defaultMessage: 'View installed skills that extend NGOPilot capabilities. {shortcut} to search.',
  },
