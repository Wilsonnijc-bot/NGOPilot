...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using NGOPilot.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve NGOPilot. We never collect your conversations, code, or personal data.',
  },
  learnMore: {
