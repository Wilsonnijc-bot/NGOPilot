...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'NGOPilot is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'NGOPilot is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'NGOPilot is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'NGOPilot is compacting the conversation...',
  },
  idle: {
