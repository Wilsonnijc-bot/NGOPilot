...
const isLinuxVulkanBuild = process.env.NGOPILOT_DESKTOP_LINUX_VARIANT === 'vulkan';
...
let cfg = {
  ...
  extendInfo: {
    ...
    NSMicrophoneUsageDescription:
      'NGOPilot needs access to your microphone for voice dictation.',
    NSAppleEventsUsageDescription:
      'NGOPilot needs access to send Apple Events to control other apps on your behalf.',
  },
};
...
module.exports = {
  ...
  makers: [
    ...
    },
    {
      ...
      config: {
        options: {
          id: 'org.ngopilot.NGOPilot',
          categories: ['Development'],
          mimeType: ['x-scheme-handler/ngopilot'],
          icon: {
